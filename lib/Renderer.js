...
class Renderer extends EventEmitter
{
    ...
    async render(viewScript, viewData = {}) {
        ...
        let viewEngine = this.engine(viewScript, options);

        let filename = this.resolve(viewScript, viewPaths, viewExt);
        ...
        if(viewLayout) {
            ...
            viewEngine = this.engine(viewLayout, options);
            filename = this.resolve(viewLayout, viewPaths, viewExt);
